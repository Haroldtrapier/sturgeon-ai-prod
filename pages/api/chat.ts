...
// Agent-specific instructions for government contracting domain
...
export default async function handler(
  ...
  try {
    ...
    // Select appropriate agent instructions based on type
    ...
    const systemPrompt = agentInstructions[selectedAgentType];
