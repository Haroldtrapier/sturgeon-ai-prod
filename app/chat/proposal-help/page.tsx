...
export default function ProposalHelpChatPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] max-w-4xl mx-auto">
      <div className="flex-shrink-0 px-4 py-3 border-b border-slate-800"><h1 className="text-xl font-bold">Proposal Help</h1><p className="text-xs text-slate-400">Powered by the Proposal Writing Assistant</p></div>
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        {sending && <div className="flex justify-start"><div className="bg-slate-800 rounded-xl px-4 py-3 text-sm text-slate-400">Drafting proposal content...</div></div>}
        <div ref={endRef} />
      </div>
