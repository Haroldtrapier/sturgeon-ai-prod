...
export default function PricingHelpChatPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] max-w-4xl mx-auto">
      <div className="flex-shrink-0 px-4 py-3 border-b border-stone-200"><h1 className="text-xl font-bold">Pricing Help</h1><p className="text-xs text-stone-500">Government contract pricing strategy assistant</p></div>
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        {sending && <div className="flex justify-start"><div className="bg-stone-100 rounded-xl px-4 py-3 text-sm text-stone-500">Analyzing pricing strategy...</div></div>}
        <div ref={endRef} />
      </div>
